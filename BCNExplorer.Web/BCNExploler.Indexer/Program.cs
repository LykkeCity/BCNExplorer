...
namespace BCNExploler.Indexer
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var client  = new IndexerClient(configuration);
            var hashValue = "000000000000025e16312be59fd8e044bd9fb61321ce20755bb2857fc8786541";
            var blockId = NBitcoin.uint256.Parse(hashValue);

            var bl = client.GetBlock(blockId);
            var t2 = bl;
        }
